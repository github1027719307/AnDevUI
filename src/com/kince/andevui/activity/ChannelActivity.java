...
import com.kince.andevui.adapter.DragAdapter;
import com.kince.andevui.adapter.OtherAdapter;
...
import com.kince.andevui.widget.DragGrid;
import com.kince.andevui.widget.OtherGridView;
...
public class ChannelActivity extends FragmentActivity implements
	...
	private void initData() {
		userChannelList = ((ArrayList<ChannelItem>) ChannelManage.getManage(
				AndApplication.getAppInstance().getSQLHelper()).getUserChannel());
		otherChannelList = ((ArrayList<ChannelItem>) ChannelManage.getManage(
				AndApplication.getAppInstance().getSQLHelper()).getOtherChannel());
	...
	private void initView() {
		...
		mTextView = (TextView) findViewById(R.id.tv_back);
			...
			public void onClick(View v) {
				...
				if (userAdapter.isListChanged()) {
					Intent intent = new Intent(getApplicationContext(),
							MainActivity.class);
					setResult(MainUiFragment.CHANNELRESULT, intent);
					finish();
					Log.d(TAG, "数据发生改变");
				} else {
					finish();
	...
	private void saveChannel() {
		ChannelManage.getManage(AndApplication.getAppInstance().getSQLHelper())
				.deleteAllChannel();
		ChannelManage.getManage(AndApplication.getAppInstance().getSQLHelper())
